---
label: "VerusID LoginConsent: API-Based Flow"
icon: shield-check
order: 45
---
...
- [verus-typescript-primitives](https://github.com/VerusCoin/verus-typescript-primitives)
- [verusid-ts-client](https://github.com/VerusCoin/verusid-ts-client)
- [Verus Mobile LoginConsent](https://github.com/VerusCoin/Verus-Mobile) (src/containers/DeepLink/)
